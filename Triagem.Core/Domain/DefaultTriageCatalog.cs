    ...
    [
        new(
            ...
            [
                ...
                new("6. A saliva escorre pela boca?", 2, "Deglutição"),
                new("7. Apresenta dificuldade para memorizar coisas do dia a dia?", 3, "Linguagem e Cognição"),
                new("8. Engasga com:", 1, "Deglutição", ["Líquidos", "Pastosos", "Sólidos", "Saliva"]),
                new("9. Atende comandos básicos: 'pegue o copo', 'guarde seu sapato'?", 2, "Linguagem e Cognição"),
                new("10. Consegue manter uma conversa por aproximadamente 5 minutos?", 3, "Linguagem e Cognição"),
                new("11. Lembra o nome dos objetos do dia a dia?", 2, "Linguagem e Cognição"),
                new("12. Sabe onde está (local e data)?", 2, "Linguagem e Cognição"),
                new("13. Apresenta voz rouca?", 3, "Voz"),
                new("14. Toma bastante água ao longo do dia?", 1, "Voz"),
                new("15. Fica cansado ao falar?", 1, "Voz"),
                new("16. Tem pigarro com frequência?", 1, "Voz"),
                new("17. Queixa-se de tontura ou zumbido frequentemente?", 2, "Audição e Equilíbrio"),
